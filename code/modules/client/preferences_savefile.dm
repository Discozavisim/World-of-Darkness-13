...
/datum/preferences/proc/load_character(slot)
	...
	READ_FILE(S["main_talent_one"], main_talent_one)
	READ_FILE(S["main_talent_two"], main_talent_two)
	READ_FILE(S["second_talent_one"], second_talent_one)
	READ_FILE(S["second_talent_two"], second_talent_two)

	READ_FILE(S["main_skill_one"], main_skill_one)
	READ_FILE(S["main_skill_two"], main_skill_two)
	READ_FILE(S["second_skill_one"], second_skill_one)
	READ_FILE(S["second_skill_two"], second_skill_two)

	READ_FILE(S["main_knowledge_one"], main_knowledge_one)
	READ_FILE(S["main_knowledge_two"], main_knowledge_two)
	READ_FILE(S["second_knowledges_one"], second_knowledge_one)
	READ_FILE(S["second_knowledges_two"], second_knowledge_two)
...
//		clane = new newtype()
	...
	main_talent_one = sanitize_text(main_talent_one, initial(main_talent_one))
	main_talent_two = sanitize_text(main_talent_two, initial(main_talent_two))
	second_talent_one = sanitize_text(second_talent_one, initial(second_talent_one))
	second_talent_two = sanitize_text(second_talent_two, initial(second_talent_two))

	main_skill_one = sanitize_text(main_skill_one, initial(main_skill_one))
	main_skill_two = sanitize_text(main_skill_two, initial(main_skill_two))
	second_skill_one = sanitize_text(second_skill_one, initial(second_skill_one))
	second_skill_two = sanitize_text(second_skill_two, initial(second_skill_two))

	main_knowledge_one = sanitize_text(main_knowledge_one, initial(main_knowledge_one))
	main_knowledge_two = sanitize_text(main_knowledge_two, initial(main_knowledge_two))
	second_knowledge_one = sanitize_text(second_knowledge_one, initial(second_knowledge_one))
	second_knowledge_two = sanitize_text(second_knowledge_two, initial(second_knowledge_two))
	...
	Alertness				= sanitize_integer(Alertness, 0, calc_max_abilities_score("Alertness"), initial(Alertness))
	Athletics				= sanitize_integer(Athletics, 0, calc_max_abilities_score("Athletics"), initial(Athletics))
	Brawl				= sanitize_integer(Brawl, 0, calc_max_abilities_score("Brawl"), initial(Brawl))
	Empathy				= sanitize_integer(Empathy, 0, calc_max_abilities_score("Empathy"), initial(Empathy))
	Intimidation				= sanitize_integer(Intimidation, 0, calc_max_abilities_score("Intimidation"), initial(Intimidation))
	Expression				= sanitize_integer(Expression, 0, calc_max_abilities_score("Expression"), initial(Expression))
	Crafts				= sanitize_integer(Crafts, 0, calc_max_abilities_score("Crafts"), initial(Crafts))
	Melee				= sanitize_integer(Melee, 0, calc_max_abilities_score("Melee"), initial(Melee))
	Firearms				= sanitize_integer(Firearms, 0, calc_max_abilities_score("Firearms"), initial(Firearms))
	Drive				= sanitize_integer(Drive, 0, calc_max_abilities_score("Drive"), initial(Drive))
	Security				= sanitize_integer(Security, 0, calc_max_abilities_score("Security"), initial(Security))
	Fleshcraft				= sanitize_integer(Fleshcraft, 0, calc_max_abilities_score("Fleshcraft"), initial(Fleshcraft))
	Finance				= sanitize_integer(Finance, 0, calc_max_abilities_score("Finance"), initial(Finance))
	Investigation				= sanitize_integer(Investigation, 0, calc_max_abilities_score("Investigation"), initial(Investigation))
	Medicine				= sanitize_integer(Medicine, 0, calc_max_abilities_score("Medicine"), initial(Medicine))
	Linguistics				= sanitize_integer(Linguistics, 0, calc_max_abilities_score("Linguistics"), initial(Linguistics))
	Occult				= sanitize_integer(Occult, 0, calc_max_abilities_score("Occult"), initial(Occult))
...
/datum/preferences/proc/save_character()
	...
	WRITE_FILE(S["main_talent_one"], main_talent_one)
	WRITE_FILE(S["main_talent_two"], main_talent_two)
	WRITE_FILE(S["second_talent_one"], second_talent_one)
	WRITE_FILE(S["second_talent_two"], second_talent_two)

	WRITE_FILE(S["main_skill_one"], main_skill_one)
	WRITE_FILE(S["main_skill_two"], main_skill_two)
	WRITE_FILE(S["second_skill_one"], second_skill_one)
	WRITE_FILE(S["second_skill_two"], second_skill_two)

	WRITE_FILE(S["main_knowledge_one"], main_knowledge_one)
	WRITE_FILE(S["main_knowledge_two"], main_knowledge_two)
	WRITE_FILE(S["second_knowledges_one"], second_knowledge_one)
	WRITE_FILE(S["second_knowledges_two"], second_knowledge_two)
